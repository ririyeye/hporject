#ifndef _SX1278_LORA_H
#define _SX1278_LORA_H
...
#define REG_LR_NBRXBYTES                             0x13 //接收最新数据包的字节数
...
typedef struct _SX1278_CTL{
	uint8_t Frequency[3];
	uint8_t powerValue;
	uint8_t SpreadingFactor;    //7-12
	uint8_t CodingRate;        //1-4
	uint8_t Bw_Frequency;       //6-9
...
#define SX_IRQ_DISABLE 0
#define SX_IRQ_RX_ENABLE (1 << 0)
#define SX_IRQ_TX_ENABLE (1 << 1)
...
typedef struct sx1278_private_data {
	...
	SX1278_CTL sx1278ctl;
	volatile int irq_triggerd;
